        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetCustomer = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibilityScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    Rank = table.Column<int>(type: "int", nullable: true),
                    ReasonAhead = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ExpectedImpact = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionsCited = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserWasCited = table.Column<bool>(type: "bit", nullable: false),
                    CitedCompetitorIds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CompetitorNamesCited = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    GeminiResponse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponseSnippet = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScanResults_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ScanResults_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_Priority",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScanResults_QuestionId",
                table: "ScanResults",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanResults_ScanDate",
                table: "ScanResults",
                column: "ScanDate",
                descending: new bool[0]);
